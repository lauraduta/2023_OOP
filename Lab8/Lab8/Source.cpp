...
//Student s (...);
//Student s1 = s; - constr de copiere (se apeleaza cand creeam un ob pe care il cop din alt ob)
//Student s2;
//s2=s;

//avem nevoie de supr inc altor operatori
...
public:
	...
	//operator !: sa returneze true daca media este peste 5, false daca media este sub 5
	...
	//dif dintre pre si post incr - dupa parametrii

	//operatorul de preincrementare -> nu primesc nici un parametru
	Student operator++()
	{
		this->varsta++;
		return *this;
	...
	//operatorul de postincrementare -> primesc un parametru int
	...
	//operatorul ++ (ambele cazuri) a.i. fiecare nota va creste cu un pct, dar dara a depasi valoarea 10
...
ostream& operator<<(ostream& out, Student s)
{
	...
	//sa se afiseze doar numele si varsta a.i. numele sa fie modificat cu # ca prima ltr, iar varsta sa apara -1
...
int main()
{
	...
	Student* ps;
	ps = &s;
	cout << (*ps).nume << endl; //pt a stii cum arata zona de memo catre care apeleaza
	cout << ps->nume << endl;
	cout << sizeof(s) << endl;
	Student s2 = s;
	cout << sizeof(s2) << endl;
