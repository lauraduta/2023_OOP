...
public:
    ...
    {
        //nu e nevoie de verificarea numitorului - operatiile se fac asupra a doua obiecte existente
        //au fost verificate in constructor
...
//y Fractie& and not Fractie - unnecessary duplicates
